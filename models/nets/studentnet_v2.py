...
_CONV_DEFS = [
    ...
    InvertedResidual(kernel=[3, 3], stride=1, depth=96, num=2, t=6),
    InvertedResidual(kernel=[3, 3], stride=2, depth=160, num=2, t=6),
    InvertedResidual(kernel=[3, 3], stride=1, depth=256, num=1, t=6),
...
def studentnet_v2(inputs,
  ...
  with tf.variable_scope(scope, 'MobilenetV2', [inputs], reuse=reuse) as scope:
    with slim.arg_scope([slim.batch_norm, slim.dropout],
      ...
      net, end_points = studentnet_v2_base(inputs, scope=scope,
                                          min_depth=min_depth,
...
def studentnet_v2_arg_scope(is_training=True,
